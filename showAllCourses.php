    ...
    <div class="container text-center">
      <div class="tranbox">
        ...
        if ($result->num_rows > 0) {
          echo "<table><tr><th>Equivalency ID</th><th>SCU Course Name</th><th>SCU Course Abbreviation</th><th>NONSCU University Name</th><th>NONSCU Course Name</th><th>NONSCU Course Abbreviation</th><th>Is it approved?</th><th>Notes</th><th>Last Modified By</th></tr>";
